function createUnityInstance(t, n, d) {
  ...
  var o,
    m = {
      ...
      wasmFileSize: 47361058,
      cacheControl: (e) => (e == m.dataUrl || e.match(/\.bundle/) ? "must-revalidate" : "no-store"),
  ...
  function E() {
    (this.isConnected = this.connect().then(() => this.cleanUpCache())),
      this.isConnected.catch((e) => {
  ...
  (m.SystemInfo = (() => {
    ...
    (m.fetchWithProgress = (e, t) => {
      var n = () => {};
      return (
        t && t.onProgress && (n = t.onProgress),
        fetch(e, t).then((e) => m.readBodyWithProgress(e, n, t.enableStreamingDownload))
      );
    }),
    (m.UnityCache =
      ...
      (E.prototype.clearCache = function () {
        ...
        return this.isConnected
          .then(() => r.execute(f.name, "clear", []))
          .then(() => r.cache.keys())
          .then(function e(t) {
            var n;
            return 0 === t.length
              ? Promise.resolve()
              : ((n = t.pop()), r.cache.delete(n).then(() => e(t)));
          });
      }),
      ...
      (E.prototype.loadRequest = function (e) {
        return this.isConnected
          .then(() => Promise.all([this.cache.match(e), this.loadRequestMetaData(e)]))
          .then((e) => {
      ...
      (E.prototype.storeRequest = function (e, t) {
        return this.isConnected.then(() => this.cache.put(e, t));
      }),
      ...
      (E.prototype.getMetaDataEntries = function () {
        ...
        return new Promise((t, n) => {
          var e = this.database.transaction([f.name], "readonly").objectStore(f.name).openCursor();
          (e.onsuccess = (e) => {
            e = e.target.result;
            e
      ...
      (E.prototype.cleanUpCache = function () {
        var i = this;
        return this.getMetaDataEntries().then((e) => {
          ...
          o.sort((e, t) => e.accessedAt - t.accessedAt);
                ...
                .then((e) => {
                  ...
                  return e
                    ? ((n = e.response),
                      ...
                      "immutable" == d.control
                        ? ((d.revalidated = !0),
                          i.updateRequestMetaData(r).then(() => {
                            U(
                              "'" +
                                d.metaData.url +
                            ...
                            ? ((e = (a = a || {}).headers || {}),
                              ...
                              n.headers.get("Last-Modified")
                                ...
                                : n.headers.get("ETag") &&
                                  ...
                                  (e["Cache-Control"] = "no-cache")),
                              c(o, a))
                            : fetch(s, { method: "HEAD" }).then(
                                (t) => (
                                  (d.revalidated = ["Last-Modified", "ETag"].every(
                                    (e) => !n.headers.get(e) || n.headers.get(e) == t.headers.get(e)
                                  )),
                                  d.revalidated
                                    ? (i.updateRequestMetaData(r).then(() => {
                                        U(
      ...
      ? 1 == m.SystemInfo.hasWebGL
        ...
        : m.SystemInfo.hasWasm
          ? ((m.startupErrorHandler = t),
            ...
            m.postRun.push(() => {
              d(1),
                m.WebPlayer.WaitForInitialization().then(() => {
